  ...
  apps: [
    {
      ...
      env: {
        ...
        ACCESSTRADE_TIKI_CPS_AID: e.ACCESSTRADE_TIKI_CPS_AID || '',
        ACCESSTRADE_CONCUNG_AID: e.ACCESSTRADE_CONCUNG_AID || '',
        ACCESSTRADE_THEFACESHOP_AID: e.ACCESSTRADE_THEFACESHOP_AID || '',
        ACCESSTRADE_HOANGHA_AID: e.ACCESSTRADE_HOANGHA_AID || '',
        ACCESSTRADE_CELLPHONES_AID: e.ACCESSTRADE_CELLPHONES_AID || '',
        ACCESSTRADE_VASCARA_AID: e.ACCESSTRADE_VASCARA_AID || '',
        ACCESSTRADE_JUNO_AID: e.ACCESSTRADE_JUNO_AID || '',
        ACCESSTRADE_PNJ_AID: e.ACCESSTRADE_PNJ_AID || '',
        ACCESSTRADE_DHC_AID: e.ACCESSTRADE_DHC_AID || '',
        ACCESSTRADE_LUG_AID: e.ACCESSTRADE_LUG_AID || '',
        ACCESSTRADE_TIKTOKSHOP_AID: e.ACCESSTRADE_TIKTOKSHOP_AID || '',
        ACCESSTRADE_VEMAYBAY_AID: e.ACCESSTRADE_VEMAYBAY_AID || '',
        ACCESSTRADE_FPT_AID: e.ACCESSTRADE_FPT_AID || '',
        WEB_URL: e.WEB_URL || '',
        API_BASE_URL: e.API_BASE_URL || `http://14.236.113.160:3004/api`,
        ...
        FACEBOOK_EMAIL: e.FACEBOOK_EMAIL || '',
        FACEBOOK_PASSWORD: e.FACEBOOK_PASSWORD || '',
      },
      instances: 1,
      autorestart: true,
      watch: false,
